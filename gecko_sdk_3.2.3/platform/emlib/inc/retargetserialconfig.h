/***************************************************************************//**
 * @file
 * @brief Provide stdio retargeting configuration parameters.onfig efm32dd11
 *******************************************************************************
 * # License
...
#define RETARGET_USART0    /* Use USART0 by default. */
  ...
  #define RETARGET_RTS_LOCATION _USART_ROUTELOC1_RTSLOC_LOC4
  #define RETARGET_CTSPORT      gpioPortH
  #define RETARGET_CTSPIN       8
  #define RETARGET_RTSPORT      gpioPortH
  #define RETARGET_RTSPIN       9
